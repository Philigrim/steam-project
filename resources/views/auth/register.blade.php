                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline1" name="usertype" value="mokytojas" class="custom-control-input" autofocus>
                            ...
                            @if($errors ->has('usertype'))
                              <span class="invalid-feedback ml-6" style="display: block;" role="alert">
                            ...
                            <div class="form-group{{ $errors->has('lastname') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" placeholder="{{ __('Pavardė') }}" type="text" name="lastname" value="{{ old('lastname') }}"  autofocus>
                                </div>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('El. paštas') }}" type="email" name="email" value="{{ old('email') }}" >
                                </div>
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" style="display: block;" role="alert">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('Slaptažodis') }}" type="password" name="password" >
                                </div>
