...
@section('content')
    ...
    <div class="container-fluid mt-1 ml--5">
        <div class="flex-row d-inline-flex">
            ...
            <div class="ml-4 bg-gradient-secondary p-2 border-bottom shadow rounded mt-2 col-md-6 align-content-around">
                <div class="flex-row">
                    <div class="col">
                        <h2>Lore ipsum dolor</h2>
                        <div class="flex-row d-inline-flex ml--2 mt--3">
                        ...
                        <p>Lorem ipsum dolor sit amet, consecteturasdas  elit, sed do asdsasdas asdasda sadadas asdasdas dasdasdas dsadasdas a asdasdas asdasda asdasd asdasdaeiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
                <div class="flex-row">
