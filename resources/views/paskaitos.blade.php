                    ...
                    <div class="ml-4 bg-gradient-secondary p-2 border-bottom shadow rounded mt-2 col-md-6">
                        <div class="col">
                            ...
                            <div class="flex-row d-inline-flex ml--2 mt--3">
                                ...
                                <h5 class="pt-3 pr-2">{{-- $event->room->steam_center_has_room->steam_center->address --}}adresas</h5>
                            ...
                            <div class="row d-flex justify-content-between">
                                <h3 class="ml-3 pt-3">{{ $event->course->lecturer_has_courses->lecturer->user->firstname }} {{ $event->course->lecturer_has_courses->lecturer->user->lastname }}</h3>
